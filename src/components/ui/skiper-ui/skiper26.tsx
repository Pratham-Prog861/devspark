...
/**
 * Skiper 26 Theme_buttons_002 â€” React + CSS + transition view api  https://developer.chrome.com/docs/web-platform/view-transitions/
 * Orignal concept from rudrodip
 * Inspired by from https://github.com/rudrodip/theme-toggle-effect
 * We respect the original creators. This is an inspired rebuild with our own taste and does not claim any ownership.
 * These animations arenâ€™t associated with the rudrodip . Theyâ€™re independent recreations meant to study interaction design
 *
 * License & Usage:
